...
class ImageScraper:
    ...
    def __init__(self, per_page=10, quality="thumb"):
        self.queries = ["dog"]
        self.query = ""
        self.per_page = per_page
        self.quality = quality
        self.download_dir = "Slide Images"
...
if __name__ == "__main__":
    queries = ["cool-robot", "big-building", "supercapacitor", "ttc", "municipality", "health-insurance-plan", "majority", "depression", "polls-majority"]
